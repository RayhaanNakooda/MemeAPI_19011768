...
namespace memes.Controllers
{
    public class MemesController : Controller
    {
        ...
        {            
            ...
            httpRequestMessage.RequestUri = new Uri("https://api.imgflip.com/caption_image?template_id=" + id + "&username=[your username]&password=[your password]=" + caption1  + "&text1=" + caption2);
